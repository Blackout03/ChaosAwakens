...
public class CARecipeProvider extends RecipeProvider {
	...
	protected void buildShapelessRecipes(Consumer<IFinishedRecipe> consumer) {
		...
		surroundItem(consumer, CAItems.CYAN_ROSE_SWORD.get(), CABlocks.CYAN_ROSE.get(), CAItems.EMERALD_SWORD.get());
		surroundItem(consumer, CAItems.RED_ROSE_SWORD.get(), CABlocks.RED_ROSE.get(), CAItems.EMERALD_SWORD.get());
		surroundItem(consumer, CAItems.CRYSTAL_ROSE_SWORD.get(), CABlocks.CRYSTAL_ROSE.get(), CAItems.EMERALD_SWORD.get());
