...
public class CAAdvancementProvider extends AdvancementProvider {
    ...
    public void run(DirectoryCache cache) {
        ...
        Consumer<Advancement> consumer = (advancement) -> {
            ...
            ChaosAwakens.LOGGER.debug("Advancement Requirement: " + Arrays.deepToString(advancement.getRequirements()));
    ...
    public void register(Consumer<Advancement> t) {
        ...
        Advancement poppySword = registerAdvancement("poppy_sword", FrameType.GOAL, CAItems.POPPY_SWORD.get()).parent(root).addCriterion("poppy_sword",
                InventoryChangeTrigger.Instance.hasItems(CAItems.POPPY_SWORD.get())).save(t, id("poppy_sword"));
        ...
        Advancement antAnnihilator = registerAdvancement("ant_annihilator", FrameType.TASK, CAItems.UNSTABLE_ANT_SPAWN_EGG.get()).parent(root).addCriterion("brown_ant",
                ...
                KilledTrigger.Instance.playerKilledEntity(EntityPredicate.Builder.entity().of(CAEntityTypes.TERMITE.get()))).save(t, id("ant_annihilator"));
        ...
        Advancement trophyWorthy = registerAdvancement("trophy_worthy", FrameType.CHALLENGE, CABlocks.PLATINUM_BLOCK.get()).parent(root).addCriterion("platinum_block",
                InventoryChangeTrigger.Instance.hasItems(CABlocks.PLATINUM_BLOCK.get())).addCriterion("uranium_block",
                InventoryChangeTrigger.Instance.hasItems(CABlocks.URANIUM_BLOCK.get())).addCriterion("titanium_block",
                InventoryChangeTrigger.Instance.hasItems(CABlocks.TITANIUM_BLOCK.get())).save(t, id("trophy_worthy"));
