...
//        registerFlammable(CABlocks.PAEONIA.get(), 60, 100);
        registerFlammable(CABlocks.STRAWBERRY_PLANT.get(), 60, 100);
...
//        registerCompostable(0.65F, CABlocks.PINK_CRYSTAL_GROWTH.get());
    ...
    public static void registerFurnaceFuel(FurnaceFuelBurnTimeEvent event) {
        ...
        } else if (fuel.getItem() == CABlocks.CRYSTAL_CRAFTING_TABLE.get().asItem() || fuel.getItem() == CABlocks.MOLDY_FENCE.get().asItem()) {
        ...
        } else if (fuel.getItem() == CAItems.CRYSTAL_WOOD_SHARD.get()) {
