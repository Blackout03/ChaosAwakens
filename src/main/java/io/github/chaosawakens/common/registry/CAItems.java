...
public class CAItems {
    ...
    public static final Food FOOD_COOKED_BACON = new Food.Builder().nutrition(14).saturationMod(1.0F).meat().effect(() -> new EffectInstance(Effects.WEAKNESS, 2000, 0), 1.0F).effect(() -> new EffectInstance(Effects.POISON, 2000, 0), 1.0F).build();
    ...
    public static final Food FOOD_LAVA_EEL = new Food.Builder().nutrition(2).saturationMod(0.6F).alwaysEat().effect(() -> new EffectInstance(Effects.LEVITATION, 600, 0), 1.0F).build();
    ...
    public static final Food FOOD_CRYSTAL_APPLE = new Food.Builder().nutrition(5).saturationMod(0.85F).effect(() -> new EffectInstance(Effects.WEAKNESS, 3000, 0), 1.0F).effect(() -> new EffectInstance(Effects.POISON, 3000, 0), 1.0F).build();
    ...
    public static final Food FOOD_GOLDEN_CHICKEN = new Food.Builder().nutrition(6).saturationMod(0.45F).meat().alwaysEat().effect(() -> new EffectInstance(Effects.WEAKNESS, 600, 0), 1.0F).build();
    public static final Food FOOD_GOLDEN_TROPICAL_FISH = new Food.Builder().nutrition(4).saturationMod(0.2F).alwaysEat().effect(() -> new EffectInstance(Effects.POISON, 2400, 0), 1.0F).build();
    public static final Food FOOD_GOLDEN_COD = new Food.Builder().nutrition(5).saturationMod(0.3F).alwaysEat().effect(() -> new EffectInstance(Effects.POISON, 200, 0), 1.0F).build();
    public static final Food FOOD_GOLDEN_PORKCHOP = new Food.Builder().nutrition(8).saturationMod(1.1F).meat().alwaysEat().effect(() -> new EffectInstance(Effects.WEAKNESS, 600, 0), 1.0F).build();
    public static final Food FOOD_GOLDEN_MELON_SLICE = new Food.Builder().nutrition(8).saturationMod(0.45F).alwaysEat().build();
    public static final Food FOOD_GOLDEN_MUSHROOM_STEW = new Food.Builder().nutrition(6).saturationMod(0.25F).alwaysEat().effect(() -> new EffectInstance(Effects.MOVEMENT_SLOWDOWN, 700, 0), 1.0F).build();
    public static final Food FOOD_GOLDEN_STEAK = new Food.Builder().nutrition(8).saturationMod(1.1F).meat().alwaysEat().effect(() -> new EffectInstance(Effects.WEAKNESS, 400, 0), 1.0F).build();
    public static final Food FOOD_GOLDEN_COOKIE = new Food.Builder().nutrition(2).saturationMod(0.15F).alwaysEat().effect(() -> new EffectInstance(Effects.POISON, 100, 0), 1.0F).build();
    public static final Food FOOD_GOLDEN_POTATO = new Food.Builder().nutrition(6).saturationMod(0.65F).alwaysEat().effect(() -> new EffectInstance(Effects.POISON, 400, 0), 1.0F).build();
    public static final Food FOOD_GOLDEN_PUMPKIN_PIE = new Food.Builder().nutrition(8).saturationMod(9).alwaysEat().effect(() -> new EffectInstance(Effects.BLINDNESS, 600, 0), 1.0F).build();
    public static final Food FOOD_GOLDEN_FLESH = new Food.Builder().nutrition(4).saturationMod(0.3F).alwaysEat().effect(() -> new EffectInstance(Effects.HUNGER, 40, 0), 1.0F).build();
    public static final Food FOOD_GOLDEN_PUFFERFISH = new Food.Builder().nutrition(4).saturationMod(0.3F).alwaysEat().effect(() -> new EffectInstance(Effects.POISON, 100, 0), 1.0F).effect(() -> new EffectInstance(Effects.BLINDNESS, 1800, 0), 1.0F).effect(() -> new EffectInstance(Effects.GLOWING, 3600, 0), 1.0F).build();
    public static final Food FOOD_GOLDEN_SALMON = new Food.Builder().nutrition(8).saturationMod(0.85F).alwaysEat().effect(() -> new EffectInstance(Effects.CONFUSION, 1800, 0), 1.0F).effect(() -> new EffectInstance(Effects.MOVEMENT_SLOWDOWN, 1800, 1), 1.0F).build();
    public static final Food FOOD_GOLDEN_CANDYCANE = new Food.Builder().nutrition(4).saturationMod(0.25F).alwaysEat().effect(() -> new EffectInstance(Effects.DIG_SLOWDOWN, 800, 1), 1.0F).effect(() -> new EffectInstance(Effects.CONFUSION, 600, 0), 1.0F).effect(() -> new EffectInstance(Effects.MOVEMENT_SLOWDOWN, 600, 0), 1.0F).build();
    public static final Food FOOD_ULTIMATE_APPLE = new Food.Builder().nutrition(10).saturationMod(1.5F).alwaysEat().effect(() -> new EffectInstance(Effects.WEAKNESS, 3900, 2), 1.0F).effect(() -> new EffectInstance(Effects.POISON, 4800, 3), 1.0F).effect(() -> new EffectInstance(Effects.WITHER, 5400, 2), 1.0F).effect(() -> new EffectInstance(Effects.LEVITATION, 7200, 0), 1.0F).build();
    public static final Food FOOD_ENCHANTED_GOLDEN_CARROT = new Food.Builder().nutrition(8).saturationMod(0.85F).alwaysEat().effect(() -> new EffectInstance(Effects.POISON, 600, 2), 1.0F).effect(() -> new EffectInstance(Effects.BLINDNESS, 1200, 0), 1.0F).effect(() -> new EffectInstance(Effects.WITHER, 1200, 0), 1.0F).build();
    public static final Food FOOD_ENCHANTED_GOLDEN_STEAK = new Food.Builder().nutrition(10).saturationMod(1.2F).alwaysEat().effect(() -> new EffectInstance(Effects.WITHER, 900, 0), 1.0F).effect(() -> new EffectInstance(Effects.WEAKNESS, 1800, 1), 1.0F).effect(() -> new EffectInstance(Effects.POISON, 1800, 0), 1.0F).build();
    public static final Food FOOD_ENCHANTED_GOLDEN_COD = new Food.Builder().nutrition(8).saturationMod(0.85F).alwaysEat().effect(() -> new EffectInstance(Effects.POISON, 600, 2), 1.0F).effect(() -> new EffectInstance(Effects.GLOWING, 900, 0), 1.0F).build();
    public static final Food FOOD_ENCHANTED_GOLDEN_COOKIE = new Food.Builder().nutrition(4).saturationMod(0.85F).alwaysEat().effect(() -> new EffectInstance(Effects.POISON, 600, 1), 1.0F).effect(() -> new EffectInstance(Effects.MOVEMENT_SLOWDOWN, 1000, 1), 1.0F).build();
    public static final Food FOOD_ENCHANTED_GOLDEN_CANDYCANE = new Food.Builder().nutrition(6).saturationMod(0.3F).alwaysEat().effect(() -> new EffectInstance(Effects.WEAKNESS, 300, 0), 1.0F).effect(() -> new EffectInstance(Effects.POISON, 300, 0), 1.0F).effect(() -> new EffectInstance(Effects.DIG_SLOWDOWN, 600, 2), 1.0F).effect(() -> new EffectInstance(Effects.CONFUSION, 900, 1), 1.0F).effect(() -> new EffectInstance(Effects.MOVEMENT_SLOWDOWN, 900, 1), 1.0F).build();

    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, ChaosAwakens.MODID);

    // APRIL FOOLS ITEMS
    public static final RegistryObject<Item> FLAMING_HOT_CHEETOS = ITEMS.register("flaming_hot_cheetos", () -> new Item(new Item.Properties().food(CAItems.FOOD_FLAMING_HOT_CHEETOS).tab(CAItemGroups.FOOD)));
    public static final RegistryObject<PoppySwordItem> POPPY_SWORD = ITEMS.register("poppy_sword", () -> new PoppySwordItem(CAItemTier.TOOL_POPPY, CAConfig.COMMON.poppySwordDamage.get() - 41, 3, new Item.Properties().rarity(Rarity.RARE).tab(CAItemGroups.EQUIPMENT)));
    public static final RegistryObject<WallOrFloorItem> CHERRY_TORCH = ITEMS.register("cherry_torch", () -> new WallOrFloorItem(CABlocks.CHERRY_TORCH.get(), CABlocks.WALL_CHERRY_TORCH.get(), new Item.Properties().tab(CAItemGroups.BLOCKS)));
    ...
    public static final RegistryObject<Item> WOOD_FISH = ITEMS.register("wood_fish", () -> new Item(new Item.Properties().food(Foods.COD).tab(CAItemGroups.FOOD)));
    ...
    // TOOLS
    // Ultimate
    public static final RegistryObject<SwordItem> ULTIMATE_SWORD = ITEMS.register("ultimate_sword", () -> new EnchantedSwordItem(CAItemTier.TOOL_ULTIMATE, CAConfig.COMMON.ultimateSwordDamage.get() - 40, -2.4F, new Item.Properties().rarity(Rarity.RARE).tab(CAItemGroups.EQUIPMENT),
    ...
    public static final RegistryObject<HoeItem> ULTIMATE_HOE = ITEMS.register("ultimate_hoe", () -> new UltimateHoeItem(CAItemTier.TOOL_ULTIMATE, CAConfig.COMMON.ultimateHoeDamage.get() - 37, 0.0F, new Item.Properties().rarity(Rarity.RARE).tab(CAItemGroups.EQUIPMENT),
            new EnchantmentData[]{new EnchantmentData(Enchantments.BLOCK_EFFICIENCY, 5), new EnchantmentData(Enchantments.BLOCK_FORTUNE, 5), new EnchantmentData(Enchantments.UNBREAKING, 2)}));
    public static final RegistryObject<UltimateBowItem> ULTIMATE_BOW = ITEMS.register("ultimate_bow", () -> new UltimateBowItem(new Item.Properties().rarity(Rarity.RARE).tab(CAItemGroups.EQUIPMENT).stacksTo(1).durability(1000),
    ...
    public static final RegistryObject<UltimateFishingRodItem> ULTIMATE_FISHING_ROD = ITEMS.register("ultimate_fishing_rod", () -> new UltimateFishingRodItem(new Item.Properties().rarity(Rarity.RARE).tab(CAItemGroups.EQUIPMENT).stacksTo(1).durability(1000),
            new EnchantmentData[]{new EnchantmentData(Enchantments.UNBREAKING, 2)}));

    public static final RegistryObject<ExtendedHitWeaponItem> BIG_BERTHA = ITEMS.register("big_bertha", () -> new ExtendedHitWeaponItem(CAItemTier.WEAPON_BERTHA, CAConfig.COMMON.berthaDamage.get() - 497, -3.2F, 5F, new Item.Properties().rarity(Rarity.EPIC).tab(CAItemGroups.EQUIPMENT).setISTER(() -> BigBerthaItemRender::new),
    ...
    // Misc. Weapons
    public static final RegistryObject<SwordItem> NIGHTMARE_SWORD = ITEMS.register("nightmare_sword", () -> new EnchantedSwordItem(CAItemTier.TOOL_NIGHTMARE, CAConfig.COMMON.nightmareSwordDamage.get() - 28, -2.4F, new Item.Properties().tab(CAItemGroups.EQUIPMENT),
    ...
    public static final RegistryObject<SwordItem> EXPERIENCE_SWORD = ITEMS.register("experience_sword", () -> new EnchantedSwordItem(CAItemTier.TOOL_EMERALD, CAConfig.COMMON.experienceSwordDamage.get() - 8, -2.4F, new Item.Properties().tab(CAItemGroups.EQUIPMENT),
    ...
    public static final RegistryObject<SwordItem> POISON_SWORD = ITEMS.register("poison_sword", () -> new PoisonSwordItem(CAItemTier.TOOL_EMERALD, CAConfig.COMMON.poisonSwordDamage.get() - 8, -2.4F, new Item.Properties().tab(CAItemGroups.EQUIPMENT),
    ...
    public static final RegistryObject<SwordItem> MANTIS_CLAW = ITEMS.register("mantis_claw", () -> new MantisClawItem(CAItemTier.WEAPON_GENERIC, CAConfig.COMMON.mantisClawDamage.get() - 12, -3F, new Item.Properties().rarity(Rarity.RARE).tab(CAItemGroups.EQUIPMENT)));
    public static final RegistryObject<SwordItem> BIG_HAMMER = ITEMS.register("big_hammer", () -> new BigHammerItem(CAItemTier.WEAPON_BIG_HAMMER, CAConfig.COMMON.bigHammerDamage.get() - 12, -3F, new Item.Properties().rarity(Rarity.RARE).tab(CAItemGroups.EQUIPMENT)));
    public static final RegistryObject<ScytheItem> PRISMATIC_REAPER = ITEMS.register("prismatic_reaper", () -> new EnchantedScytheItem(CAItemTier.TOOL_ULTIMATE, CAConfig.COMMON.prismaticReaperDamage.get() - 37, -1.9F, new Item.Properties().tab(CAItemGroups.EQUIPMENT),
    ...
    public static final RegistryObject<AxeItem> BATTLE_AXE = ITEMS.register("battle_axe", () -> new EnchantedAxeItem(CAItemTier.WEAPON_BATTLEAXE, CAConfig.COMMON.battleAxeDamage.get() - 48, -3F, new Item.Properties().rarity(Rarity.RARE).tab(CAItemGroups.EQUIPMENT),
            new EnchantmentData[]{new EnchantmentData(Enchantments.MOB_LOOTING, 3), new EnchantmentData(Enchantments.UNBREAKING, 3)}));
    public static final RegistryObject<AxeItem> QUEEN_SCALE_BATTLE_AXE = ITEMS.register("queen_scale_battle_axe", () -> new EnchantedAxeItem(CAItemTier.WEAPON_QUEEN_BATTLEAXE, CAConfig.COMMON.queenAxeDamage.get() - 664, -2.8F, new Item.Properties().rarity(RARITY_ROYALTY).tab(CAItemGroups.EQUIPMENT),
            new EnchantmentData[]{new EnchantmentData(Enchantments.SHARPNESS, 5), new EnchantmentData(Enchantments.SMITE, 5), new EnchantmentData(Enchantments.BANE_OF_ARTHROPODS, 5), new EnchantmentData(Enchantments.KNOCKBACK, 3), new EnchantmentData(Enchantments.MOB_LOOTING, 3), new EnchantmentData(Enchantments.UNBREAKING, 2), new EnchantmentData(Enchantments.FIRE_ASPECT, 2)}));
    ...
    // Royal Guardian
    public static final RegistryObject<ArmorItem> ROYAL_GUARDIAN_HELMET = ITEMS.register("royal_guardian_helmet", () -> new EnchantedArmorItem(CAArmorMaterial.ROYAL_GUARDIAN, EquipmentSlotType.HEAD, new Item.Properties().rarity(RARITY_ROYALTY).tab(CAItemGroups.EQUIPMENT),
    ...
    public static final RegistryObject<ArmorItem> ROYAL_GUARDIAN_CHESTPLATE = ITEMS.register("royal_guardian_chestplate", () -> new EnchantedArmorItem(CAArmorMaterial.ROYAL_GUARDIAN, EquipmentSlotType.CHEST, new Item.Properties().rarity(RARITY_ROYALTY).tab(CAItemGroups.EQUIPMENT),
    ...
    public static final RegistryObject<ArmorItem> ROYAL_GUARDIAN_LEGGINGS = ITEMS.register("royal_guardian_leggings", () -> new EnchantedArmorItem(CAArmorMaterial.ROYAL_GUARDIAN, EquipmentSlotType.LEGS, new Item.Properties().rarity(RARITY_ROYALTY).tab(CAItemGroups.EQUIPMENT),
            new EnchantmentData[]{new EnchantmentData(Enchantments.ALL_DAMAGE_PROTECTION, 10), new EnchantmentData(Enchantments.FIRE_PROTECTION, 10), new EnchantmentData(Enchantments.BLAST_PROTECTION, 10), new EnchantmentData(Enchantments.PROJECTILE_PROTECTION, 10), new EnchantmentData(Enchantments.UNBREAKING, 5)}));
    public static final RegistryObject<ArmorItem> ROYAL_GUARDIAN_BOOTS = ITEMS.register("royal_guardian_boots", () -> new RoyaltyBootsItem(CAArmorMaterial.ROYAL_GUARDIAN, new Item.Properties().rarity(RARITY_ROYALTY).tab(CAItemGroups.EQUIPMENT),
