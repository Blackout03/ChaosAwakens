...
public class CherryCampfireBlock extends ContainerBlock implements IWaterLoggable {
    ...
    public void entityInside(BlockState state, World world, BlockPos pos, Entity entity) {
        if (entity.isAlive() && entity != null) {
            ...
            if (!livingEntity.hasEffect(Effects.HEALTH_BOOST)) {
    ...
    public void onRemove(BlockState p_196243_1_, World p_196243_2_, BlockPos p_196243_3_, BlockState p_196243_4_, boolean p_196243_5_) {
        if (!p_196243_1_.is(p_196243_4_.getBlock())) {
            ...
            if (tileentity instanceof CherryCampfireTileEntity) {
                InventoryHelper.dropContents(p_196243_2_, p_196243_3_, ((CherryCampfireTileEntity)tileentity).getItems());
            }
    ...
    public BlockState getStateForPlacement(BlockItemUseContext p_196258_1_) {
        ...
        return this.defaultBlockState().setValue(WATERLOGGED, flag).setValue(SIGNAL_FIRE, this.isSmokeSource(iworld.getBlockState(blockpos.below()))).setValue(LIT, !flag).setValue(FACING, p_196258_1_.getHorizontalDirection());
    }
    ...
    public BlockState updateShape(BlockState p_196271_1_, Direction p_196271_2_, BlockState p_196271_3_, IWorld p_196271_4_, BlockPos p_196271_5_, BlockPos p_196271_6_) {
        ...
        return p_196271_2_ == Direction.DOWN ? p_196271_1_.setValue(SIGNAL_FIRE, this.isSmokeSource(p_196271_3_)) : super.updateShape(p_196271_1_, p_196271_2_, p_196271_3_, p_196271_4_, p_196271_5_, p_196271_6_);
    }
        ...
        if (p_180655_1_.getValue(LIT)) {
            ...
            if (this.spawnParticles && p_180655_4_.nextInt(5) == 0) {
                for(int i = 0; i < p_180655_4_.nextInt(1) + 1; ++i) {
                    p_180655_2_.addParticle(ParticleTypes.LAVA, (double)p_180655_3_.getX() + 0.5D, (double)p_180655_3_.getY() + 0.5D, (double)p_180655_3_.getZ() + 0.5D, (p_180655_4_.nextFloat() / 2.0F), 5.0E-5D, (p_180655_4_.nextFloat() / 2.0F));
                }
            }
    ...
    public static void dowse(IWorld p_235475_0_, BlockPos p_235475_1_, BlockState p_235475_2_) {
        ...
        if (tileentity instanceof CherryCampfireTileEntity) {
            ((CherryCampfireTileEntity)tileentity).dowse();
        }
        ...
        if (!p_204509_3_.getValue(BlockStateProperties.WATERLOGGED) && p_204509_4_.getType() == Fluids.WATER) {
            ...
            if (flag) {
                if (!p_204509_1_.isClientSide()) {
                    p_204509_1_.playSound(null, p_204509_2_, SoundEvents.GENERIC_EXTINGUISH_FIRE, SoundCategory.BLOCKS, 1.0F, 1.0F);
                }

                dowse(p_204509_1_, p_204509_2_, p_204509_3_);
            }

            p_204509_1_.setBlock(p_204509_2_, p_204509_3_.setValue(WATERLOGGED, true).setValue(LIT, false), 3);
    ...
    public void onProjectileHit(World p_220066_1_, BlockState p_220066_2_, BlockRayTraceResult p_220066_3_, ProjectileEntity p_220066_4_) {
        if (!p_220066_1_.isClientSide && p_220066_4_.isOnFire()) {
            ...
            if (flag && !p_220066_2_.getValue(LIT) && !p_220066_2_.getValue(WATERLOGGED)) {
                ...
                p_220066_1_.setBlock(blockpos, p_220066_2_.setValue(BlockStateProperties.LIT, true), 11);
            }
        }
    ...
    public TileEntity newBlockEntity(IBlockReader p_196283_1_) {
        return new CherryCampfireTileEntity();
    }
    ...
    public static boolean canLight(BlockState p_241470_0_) {
        return p_241470_0_.is(BlockTags.CAMPFIRES, (p_241469_0_) -> p_241469_0_.hasProperty(BlockStateProperties.WATERLOGGED) && p_241469_0_.hasProperty(BlockStateProperties.LIT)) && !p_241470_0_.getValue(BlockStateProperties.WATERLOGGED) && !p_241470_0_.getValue(BlockStateProperties.LIT);
    }
}
